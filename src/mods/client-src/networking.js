...
function modifyRoomProperties() {
  ...
  (mapSelectionPrivate.script.popup.itemNames = ['FloatingIslands', 'Sierra.Snow', 'Sierra-Halloween']),
  (mapSelectionPrivate.script.popup.itemImages = [32202739, 32202738, 32202739]);
